...
pub fn get_functions_csv_path(version: &Option<String>) -> PathBuf {
...
pub fn get_functions(version: &Option<String>) -> Result<Vec<Info>> {
    get_functions_for_path(get_functions_csv_path(version).as_path())
}

pub fn write_functions(functions: &[Info], version: &Option<String>) -> Result<()> {
